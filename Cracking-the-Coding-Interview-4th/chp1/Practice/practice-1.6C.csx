/**
* Problem:  
*  Given an image represented by an MxN matrix, where each pixel in the image is 4 bytes, write a method to flip the image on it's head by 180 degrees.
*/
using System;
